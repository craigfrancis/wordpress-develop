...
function _wp_delete_orphaned_draft_menu_items() {
	...
	$menu_items_to_delete = $wpdb->get_col( $wpdb->prepare( 'SELECT ID FROM %i AS p LEFT JOIN %i AS m ON p.ID = m.post_id WHERE post_type = "nav_menu_item" AND post_status = "draft" AND meta_key = "_menu_item_orphaned" AND meta_value < %d', $wpdb->posts, $wpdb->postmeta, $delete_timestamp ) );
