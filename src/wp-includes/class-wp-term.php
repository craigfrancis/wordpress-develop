...
final class WP_Term {
	...
	public static function get_instance( $term_id, $taxonomy = null ) {
		...
		if ( ! $_term || ( $taxonomy && $taxonomy !== $_term->taxonomy ) ) {
			...
			$terms = $wpdb->get_results( $wpdb->prepare( 'SELECT t.*, tt.* FROM %i AS t INNER JOIN %i AS tt ON t.term_id = tt.term_id WHERE t.term_id = %d', $wpdb->terms, $wpdb->term_taxonomy, $term_id ) );
			if ( ! $terms ) {
				return false;
			}
